...
const Portfolios = () => {
  ...
  const personalProjects = [
    {
      ...
      codeLink: "https://github.com/cadetvivek/yogasana",
      badge: "Firebase",
    ...
    },
    {
      ...
      codeLink: "https://github.com/cadetvivek/zoocoAssignment",
      badge: "MERN Stack",
    ...
    },
    {
      ...
      codeLink: "https://github.com/cadetvivek/Tenant-Landlord",
      badge: "AI Features",
  ...
  return (
    <div name="portfolio" className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <p className="text-gray-600 text-base">Building innovative solutions</p>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className={`flex-1 bg-gradient-to-r ${project.gradient} text-white text-center py-2 px-4 rounded-lg font-medium hover:shadow-lg transition-all duration-300 hover:scale-105`}
                  >
                    Live Demo
                  </a>
                  {project.codeLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 bg-gray-100 text-gray-700 text-center py-2 px-4 rounded-lg font-medium hover:bg-gray-200 transition-all duration-300 hover:scale-105"
                    >
                      Code
                    </a>
                  )}
                  {!project.codeLink && (
                    <div className="flex-1 bg-gray-100 text-gray-400 text-center py-2 px-4 rounded-lg font-medium cursor-not-allowed">
                      Private
                    </div>
                  )}
                </div>
